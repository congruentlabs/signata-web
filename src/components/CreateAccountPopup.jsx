...
function CreateAccountPopup({ open, handleClickClose, handleClickConnect, recoveryPassphrase }) {
  return (
    <Dialog
      open={open}
      ...
      <DialogContent>
        <Stack>
          ...
          <Typography variant="body1" gutterBottom>
            ...
            same seed as your wallet, and do
          </Typography>
          <TextField label="Recovery Passphrase" variant="outlined" value={recoveryPassphrase} />
        </Stack>
      </DialogContent>
      <DialogActions>
