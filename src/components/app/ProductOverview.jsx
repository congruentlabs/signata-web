  ...
  return (
    <Stack spacing={1} paddingTop={4}>
      <Typography variant="h4">
        Welcome to Signata, the future of Online Identity
      </Typography>
      <Typography variant="body1">
        Blockchain technology is a powerful new means to build distributed and
        self-sovereign systems. Create and manage your online identities with
        Signata, and take control of your online life.
      </Typography>
      ...
      <Typography variant="body1">
        An identity is only as valuable as the services it can be used within.
        Start integrating Signata identities into your products and services
        today.
      </Typography>
      <Button
        target="_blank"
      ...
      <Typography variant="body1">
        ...
        Organization (DAO), not by Big Tech or Governments. Join the ecosystem
        to have your say and build a better online future.
      </Typography>
      <Button
        target="_blank"
